...
function Navbar() {
  ...
  return (
    <>
        ...
        {/*  Header */}
    <header className="lg:flex lg:flex-row lg:justify-around lg:items-center lg:p-9 lg:bg-[#FFF5EB] lg:shadow-sm max-h-[100px] md:flex md:flex-row md:justify-between md:items-center md:p-9 md:bg-[#FFF5EB] md:shadow-sm flex flex-row justify-between items-center p-9 bg-[#FFF5EB] shadow-sm fixed top-0 left-0 z-100 min-w-[100%]">
