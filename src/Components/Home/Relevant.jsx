...
function Relevant() {
  return (
    <section className="my-[40px] flex flex-col items-center justify-center p-[50px] gap-[10px] w-full min-w-full max-w-full">
        ...
        {/* RelevantCards */}
        <div className="lg:flex lg:flex-row md:flex md:flex-row md:flex-wrap flex flex-col lg:gap-[20px] md:gap-[20px] gap-[40px] items-center justify-center mt-[30px] p-[20px] w-full min-w-full max-w-full">

            {/* Card 1 */}
            <div className="flex flex-col items-start justify-start gap-[15px] p-[70px] bg-[#FFF5EB] shadow-md hover:shadow-lg transition-shadow duration-300 border-b-[12px] border-[#FFD2A4] max-w-[300px] lg:max-w-[350px]">
                {/* icon */}
