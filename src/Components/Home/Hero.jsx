...
function Hero() {
  return (
    ...
    >
      {/* Hero Text */}
      <div className="flex flex-col lg:p-[90px] md:p-[70px] p-[50px] pl-[30px] text-left lg:gap-[20px] md:gap-[30px] gap-[10px] lg:mt-[30px] md:mt-[30px] mt-[10px] w-full lg:w-[60%] md:w-[85%] text-white">
        <h3 className="font-bold font-mono">WELCOME TO OUR CHURCH</h3>
        <h1 className="font-extrabold text-5xl font-mono">BECOME A PART OF OUR COMMUNITY</h1>
